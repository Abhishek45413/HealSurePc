...
public class Provider {
    ...
    // ✅ Getters and Setters for new password fields
    ...
    // 🔹 Constructors
    public Provider(String providerId, String providerName, String hospitalName, String email, String telephone,
                    String address, String city, String state, String zipcode, String password,
                    LoginStatus status, Date createdAt) {
        super();
        this.providerId = providerId;
        this.providerName = providerName;
        this.hospitalName = hospitalName;
